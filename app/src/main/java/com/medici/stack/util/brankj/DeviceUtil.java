...
public final class DeviceUtil {
    ...
    public static String getAndroidID() {
        return Settings.Secure.getString(UIUtil.getApp().getContentResolver(), Settings.Secure.ANDROID_ID);
    }
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            ...
            WifiManager wifi = (WifiManager) UIUtil.getApp().getSystemService(Context.WIFI_SERVICE);
            if (wifi != null) {
    ...
    public static void reboot() {
        ...
        UIUtil.getApp().sendBroadcast(intent);
    }
    ...
    public static void reboot(final String reason) {
        PowerManager mPowerManager = (PowerManager) UIUtil.getApp().getSystemService(Context.POWER_SERVICE);
        try {
