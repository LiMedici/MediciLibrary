...
public final class NetworkUtil {
    ...
    public static void openWirelessSettings() {
        UIUtil.getApp().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) UIUtil.getApp().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager wifiManager = (WifiManager) UIUtil.getApp().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) UIUtil.getApp()
