...
public final class ServiceUtil {
    ...
    public static Set getAllRunningService() {
        ActivityManager activityManager = (ActivityManager) UIUtil.getApp().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(UIUtil.getApp(), cls);
        UIUtil.getApp().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(UIUtil.getApp(), cls);
        return UIUtil.getApp().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls, final ServiceConnection conn, final int flags) {
        Intent intent = new Intent(UIUtil.getApp(), cls);
        UIUtil.getApp().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        UIUtil.getApp().unbindService(conn);
    }
