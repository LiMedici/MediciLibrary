 ...
 * ***************************************
 *
 * @desc: 允许添加头布局, 尾布局的Adapter,MVVM DATABINDING架构中推荐使用
 *
 * ***************************************
 */
public abstract class HFRecyclerBindingAdapter<Data> extends RecyclerBindingAdapter<Data> {
     ...
     * @param <Data> 范型
     */
    private static class HeaderAndFooterHolder<Data> extends ViewHolder<Data> {
